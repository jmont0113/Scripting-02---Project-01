...
{
    [SerializeField] Camera cam;//Camera Used To Detect Enemies On Screen      
    [SerializeField] bool addOnlyOnce;//This Boolean Is Used To Only Allow The Enemy To Be Added To The List Once
